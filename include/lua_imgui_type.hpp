...
constexpr auto lua_class_imgui_ImVec2 = "imgui.ImVec2";
...
constexpr auto lua_class_imgui_ImVec4 = "imgui.ImVec4";
...
constexpr auto lua_class_imgui_ImGuiStyle = "imgui.ImGuiStyle";
...
constexpr auto lua_class_imgui_string = "imgui.string";
constexpr auto lua_class_imgui_ImGuiTextBuffer = "imgui.ImGuiTextBuffer";
